...
function detectProject(projectPath, port) {
  const result = { framework: 'custom', command: '', suggestedPort: port || 3000, notes: [] };

  // Backend frameworks win over frontend tooling. Laravel projects commonly contain Vite.
